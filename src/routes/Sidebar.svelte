...
<div class="w-60 shrink-0 h-full">
	<div class="list-none flex flex-col pt-10 sticky top-0">
		...
		<SidebarItem to="/visualizing-tensor-contractions">Visualizing tensor contractions</SidebarItem>
		<SidebarItem to="/nonprofit-ideas">Ideas for the newly rich</SidebarItem>
